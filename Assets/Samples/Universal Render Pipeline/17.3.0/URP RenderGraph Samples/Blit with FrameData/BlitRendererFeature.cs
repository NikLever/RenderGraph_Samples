...
// Example of how Blit operations can be handled using frameData using multiple ScriptableRenderPasses.
...
public class BlitRendererFeature : ScriptableRendererFeature
{
    ...
    public class BlitData : ContextItem
    {
        ...
        public void RecordBlitColor(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            renderGraph.AddCopyPass(resourceData.activeColorTexture, texture, "BlitColorPass");
        }
        ...
        public void RecordBlitBackToColor(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            renderGraph.AddCopyPass(texture, resourceData.activeColorTexture, "BlitBackToColorPass");
        }
